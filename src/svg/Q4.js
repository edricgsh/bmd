  ...
  render() {
      ...
      <svg
        ...
        <g id="layer1">
          ...
          <path
            ...
            id="path4581"/>
          <path
            style={{fill: '#000098', fillOpacity: 1, stroke: '#0000ff', strokeWidth: '0.26418999px', strokeLinecap: 'butt', strokeLinejoin: 'miter', strokeOpacity: 1}}
            d="M 37.942717,82.120535 150.05655,81.931546"
            id="path4621"/>
          <path
            style={{fill: 'none', stroke: '#0000ff', strokeWidth: '0.26458332px', strokeLinecap: 'butt', strokeLinejoin: 'miter', strokeOpacity: 1}}
            d="M 38.353177,116.99397 149.9382,117.12761"
            id="path4623"/>
          <path
            style={{fill: 'none', stroke: '#0000fe', strokeWidth: '0.26458332px', strokeLinecap: 'butt', strokeLinejoin: 'miter', strokeOpacity: 1}}
            d="m 37.942715,82.120535 0.410462,34.873435"
            id="path4625"/>
          <path
            style={{fill: 'none', stroke: '#0000ff', strokeWidth: '0.26458332px', strokeLinecap: 'butt', strokeLinejoin: 'miter', strokeOpacity: 1}}
          ...
          <path
            style={{fill: 'none', stroke: '#0000fe', strokeWidth: '0.26458332px', strokeLinecap: 'butt', strokeLinejoin: 'miter', strokeOpacity: 1}}
            d="M 149.9382,117.12761 150.05655,81.931546 93.785557,116.89467"
            id="path4633"/>
          <path
            style={{fill: 'none', stroke: '#0000ff', strokeWidth: '0.26458332px', strokeLinecap: 'butt', strokeLinejoin: 'miter', strokeOpacity: 1}}
          ...
          <path
            style={{fill: 'none', stroke: '#0000ff', strokeWidth: '0.26458332px', strokeLinecap: 'butt', strokeLinejoin: 'miter', strokeOpacity: 1}}
            d="m 93.738093,81.931546 0.04746,34.963124"
            id="path4637"/>
          <path
          ...
          <path
            ...
            id="path4581-7" />
          <path
            style={{fill: 'none', stroke: '#0000ff', strokeWidth: '0.26615685px', strokeLinecap: 'butt', strokeLinejoin: 'miter', strokeOpacity: 0.94117647}}
            d="m 38.353177,116.99397 0.265695,19.99638"
            id="path4688" />
          <path
            style={{fill: 'none', stroke: '#0000ff', strokeWidth: '0.17108966px', strokeLinecap: 'butt', strokeLinejoin: 'miter', strokeOpacity: 1}}
            d="M 38.618872,136.99035 35.520547,128.314"
            id="path4581-7-6" />
          <path
            style={{fill: 'none', stroke: '#0000ff', strokeWidth: '0.18712629px', strokeLinecap: 'butt', strokeLinejoin: 'miter', strokeOpacity: 1}}
            d="M 38.618872,136.99035 41.675531,128.118"
            id="path4579-4-6" />
          <path
            style={{fill: '#800080', stroke: '#0000ff', strokeWidth: '0.15448797px', strokeLinecap: 'butt', strokeLinejoin: 'miter', strokeOpacity: 0.94117647}}
            d="M 6.9959026,99.500637 26.994223,99.220548"
            id="path4735" />
          <path
            style={{fill: 'none', stroke: '#0000ff', strokeWidth: '0.2318493px', strokeLinecap: 'butt', strokeLinejoin: 'miter', strokeOpacity: 0.94117647}}
            d="M 26.994223,99.220548 17.056287,96.24009"
            id="path4737" />
          <path
            style={{fill: 'none', stroke: '#0000ff', strokeWidth: '0.23327489px', strokeLinecap: 'butt', strokeLinejoin: 'miter', strokeOpacity: 0.94117647}}
    ...
    <text
       ...
       transform="scale(0.85997826,1.1628201)"><tspan
         ...
         x="167.23544"
         y="44.147202"
         style={{strokeWidth:0.11836261}}>EX: 4/5</tspan></text>
          <path
